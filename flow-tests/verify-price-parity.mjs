...
// of anything about checkout.
{
  ...
  const FAMILY_GUARD = {
    ...
    'puzzle': 'isPuzzle()',
    'wrapping paper': 'isWrap()',
    'ornament': 'isOrnament()',
    'standee': 'isStandee()',
    'business cards': 'isBusinessCards()',
    'luggage tag': 'isLuggageTag()',
    'car magnet': 'isCarMagnet()',
    'calendar': 'isDeskCalendar()',
    'tshirt': 'isTshirt()',
    'sticker sheet': 'isStickerSheet()',
...
// at the order page.
{
  ...
  const TILE_SOURCES = {
    ...
    'standee': ['custom-standee'],
    'business cards': ['business-cards', 'business-cards-boxed', 'business-card-holder'],
