...
export const PRODUCTS_CATALOG = {
  ...
  // 2026-09-22). Retail 17.95 provisional.
  "playing-cards": {
    ...
    sizes: { "Standard Deck": { variantId: 72763, price: 17.95 } },
    colors: null,
    shippingSeparate: true,
    shippingCost: 0,
    estimatedProfit: 3.99
  },
  ...
  // (probe 2026-09-22). Retail 9.95 provisional.
  "car-air-freshener": {
  ...
  // 5.39 each extra (probe 2026-09-22). Retail 16.95 provisional.
  "doormat": {
    displayName: "Doormat",
    ...
    sizes: { "18 x 30": { variantId: 112062, price: 16.95 } },
    colors: null,
    shippingSeparate: true,
    shippingCost: 0,
    estimatedProfit: 3.91
  },
  ...
  // 10.29 / 3.99 each extra (probe 2026-09-22). Retail 24.95 provisional.
  ...
  // extra (probe 2026-09-22). Retail 15.95 / 12.95 provisional. The base
  ...
  "night-buddy": {
    ...
    sizes: {
      "Full Colour": { variantId: 247088, price: 15.95 },
      "Warm Glow":   { variantId: 247089, price: 12.95 }
    },
    colors: null,
    shippingSeparate: true,
    shippingCost: 0,
    estimatedProfit: 3.68
  },
  ...
  // Retail 9.95 / 13.95 provisional. White only for now.
  "sticker-sheet": {
  ...
  // 3.99 / 2.09 each extra (probe 2026-09-22). Retail 7.95 / 9.95 / 11.95
  // provisional. cutToShape: the design is keyed to transparency so only the
  ...
  // Retail 10.95 provisional. One picture on every page for now.
  "desk-calendar": {
    ...
    sizes: { "10 x 5": { variantId: 91088, price: 10.95 } },
    colors: null,
    shippingSeparate: true,
    shippingCost: 0,
    estimatedProfit: 4.07
  },
