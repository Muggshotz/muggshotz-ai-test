...
export const PRODUCTS_CATALOG = {
  ...
  // $24.95 keeps the 8-pack under Alyx's $25 gift ceiling. Ladder TODO:
  ...
  "greeting-card": {
    ...
    // The blueprint also has an "inside" placeholder; we print the front
    // only and the inside stays blank -- buildSingleImage targets front.
    printDimensions: { front: { width: 2625, height: 1725 } },
    sizes: {
      "8-Pack": { variantId: 76175, price: 24.95 }
    },
    colors: null,
    shippingSeparate: true,
    shippingCost: 0, // resolved live per destination at checkout — see lib/printify-shipping.js
    estimatedProfit: 10.99 // $24.95 retail minus $13.96 wholesale (live probe, 2026-08-28)
  },

  // Taylor is a US printer (US ship $5.59 first item, live probe
  // 2026-08-28). Ladder TODO: 4"x6" pad is $7.01 (v96734) and five other
  // sizes exist on this blueprint whenever more rungs are wanted.
  "post-it-notes": {
    ...
    sizes: {
      "3\" x 3\"": { variantId: 96731, price: 14.95 }
    },
    colors: null,
    shippingSeparate: true,
    shippingCost: 0, // resolved live per destination at checkout — see lib/printify-shipping.js
    estimatedProfit: 8.73 // $14.95 retail minus $6.22 wholesale (live probe, 2026-08-28)
  },
