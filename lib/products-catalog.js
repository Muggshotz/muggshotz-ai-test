...
export const PRODUCTS_CATALOG = {
  ...
  "travel-mug-40oz-vacuum": {
    ...
    sizes: {
      // THE .95 GOES ON THE PRESENTED PRICE (2026-08-27, Alyx, settling it):
      //   "we don't care what the price ends up at, we care what the price is
      //    PRESENTED at. The final penny count occurs after the sale is made.
      //    The 95 versus 39 ending trick is just a psychological manipulation
      //    mechanism."
      //
      // So the rule is about the number on the tile — the one the customer
      // reads and compares — not about any computed total. Shipping and tax
      // are added after the sale and land wherever they land; they are not
      // part of the pricing decision and must not be reverse-engineered into
      // this figure.
      //
      // Two earlier passes got this wrong in opposite directions: one rounded
      // the tile to fit a $44.95 all-in total ($25.56, which is not a .95
      // price at all), the other reasoned from net margin. Neither is the
      // model. Round the PRESENTED price up to the next .95 and stop there.
      //
      ...
      //   net after Stripe $10.55
      // Sits comfortably above Alyx's "$9 profit is enough for one item".
      //
      ...
      // at nearly a third of that while being worth three times as much to us.
      "40oz": { price: 25.95 }
    },
