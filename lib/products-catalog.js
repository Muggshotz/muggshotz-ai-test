...
export const PRODUCTS_CATALOG = {
  ...
  // Retail set provisionally by Claude for the first order; Alyx to confirm.
  "wrapping-paper": {
    ...
    printProviderId: 215,
    sizes: {
      "Sheet 29\" x 20\"": { variantId: 147685, price: 14.95, printDimensions: { front: { width: 5874, height: 4205 } } },
      "Roll 29\" x 72\"":  { variantId: 147687, price: 29.95, printDimensions: { front: { width: 5874, height: 14614 } } },
      "Roll 29\" x 144\"": { variantId: 147686, price: 44.95, printDimensions: { front: { width: 5874, height: 28913 } } }
    },
    colors: null,
    shippingSeparate: true,
    shippingCost: 0, // resolved live per destination at checkout — see lib/printify-shipping.js
    estimatedProfit: 16.07 // midpoint of $9.45 (sheet), $18.05 (72"), $25.90 (144"). live probe, 2026-09-22
  },
