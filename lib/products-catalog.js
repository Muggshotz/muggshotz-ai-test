...
export const PRODUCTS_CATALOG = {
  ...
  "travel-mug-40oz-vacuum": {
    ...
    sizes: {
      ...
      // REPRICED (2026-09-20, Alyx): $24.95 -> $21.95. The reasoning above
      // is kept as the history it is; the number it argues for is no longer
      // the number. Live probe the same day: wholesale $13.96 (was recorded
      // as $13.69), US shipping $20.19 first item, billed at checkout.
      "40oz": { price: 21.95 }
    },
    ...
    // against $7.89/$2.99 for the insulated 40oz. On a $21.95 tumbler the
    // customer sees shipping at 92% of the product price. The optics are real.
    shippingCost: 0,
    // Was 9.58, an after-Stripe figure at the old $24.95. Now the same
    // convention as every other entry: retail minus wholesale.
    estimatedProfit: 7.99 // $21.95 retail minus $13.96 wholesale (live probe, 2026-09-20)
  }
