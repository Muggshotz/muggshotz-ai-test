...
export const PRODUCTS_CATALOG = {
  ...
  "photo-poster": {
    ...
    // Same note applies here as shippingCost above — base (unframed)
    // and framedUpsell almost certainly have very different real
    // profit margins, given how different their prices and blueprints
    // are. One flat number here is a starting placeholder, same
    // granularity as shippingCost; may be worth splitting into
    // per-size or base/framed-specific numbers once real costs are in.
    estimatedProfit: 0 // TODO: real estimated profit (retail minus Printify cost) — Photo/Poster
  },

  // Blueprint 2764 / provider 59 (Imagine Your Photos) -- the SAME provider as
  // the coffee mugs, so a mug + coaster order can fulfil together. Wholesale
  // $19.79 for the set of four ($4.95 a coaster), confirmed by live cost probe
  // 2026-08-26; $45.95 retail is a $26.16 profit at 57%, matching the mug.
  // Chosen over the single Cork Back Coaster (#480, $6.84 each) because a set
  // of four is both better value per unit and a more natural gift.
  "coaster-set": {
    ...
    printProviderId: 59,
    sizes: {
      "4\" x 4\"": { variantId: 149519, price: 45.95 }
    },
    colors: null,
    shippingSeparate: true,
    shippingCost: 0, // resolved live per destination at checkout — see lib/printify-shipping.js
    estimatedProfit: 26.16 // $45.95 retail minus $19.79 wholesale (live probe, 2026-08-26)
  },
  ...
  "mouse-pad": {
    ...
    printProviderId: 28,
    sizes: {
      "9\" x 8\"": { variantId: 71923, price: 11.95 }
    },
    colors: null,
    shippingSeparate: true,
    shippingCost: 0, // resolved live per destination at checkout — see lib/printify-shipping.js
    estimatedProfit: 7.07 // $11.95 retail minus $4.88 wholesale (live probe, 2026-08-26)
  },
  ...
  "travel-mug-40oz-vacuum": {
    ...
    shippingSeparate: true,
    shippingCost: 0, // TODO: real Printify shipping cost — Vacuum Thermal Tumbler 40oz
    estimatedProfit: 0 // TODO: real estimated profit (retail minus Printify cost) — Vacuum Thermal Tumbler 40oz
  }
