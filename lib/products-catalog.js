...
export const PRODUCTS_CATALOG = {
  ...
  "travel-mug-40oz-vacuum": {
    ...
    sizes: {
      ...
      // really good bargain"). Probed live, not estimated:
      //   wholesale        $13.69 flat across all 12 colours
      //   US shipping      $19.39 first item / $17.99 additional
      //   customer pays    $44.34 all-in
      //   net after Stripe  $9.58
      // For contrast, travel-mug-40oz-insulated sells at $44.95 against a
      // $39.29 wholesale and nets $3.84 — this tumbler is both cheaper for
      // the customer all-in AND worth two and a half times as much to us.
      "40oz": { price: 24.95 }
    },
