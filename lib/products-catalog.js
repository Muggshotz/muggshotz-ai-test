...
export const PRODUCTS_CATALOG = {
  ...
  // extra (probe 2026-09-22). Full Colour 14.95, Alyx's price (24 Sep 2026);
  // Warm Glow still 12.95, not yet priced by Alyx. The base
  ...
  // 3XL-5XL 12.95, Alyx's prices (24 Sep 2026). cutToShape: the design is keyed to transparency so only the
