...
export const PRODUCTS_CATALOG = {
  ...
  "framed-poster": {
    displayName: "Framed Poster (Vertical)",
    generatorIcon: "framed poster", // no generator button exists yet for this — needs one added to index.html before this is orderable end-to-end
    layoutType: "single-image",
    // CONFIRMED via real Printify catalog lookup — "Vertical Framed
    // Poster," provider "Print Pigeons." Wood frame, matte paper,
    // plexiglass front. Horizontal version exists too (blueprint 493)
    // if ever needed — not sourced today, vertical picked as primary
    // since most caricature-style photos are portrait orientation.
    blueprintId: 492,
    printProviderId: 36,
    sizes: {
      "8\" x 11\"": { price: null, colors: [
        { name: "Black", hex: "#1c1c1c", variantId: 66164 },
        { name: "White", hex: "#FFFFFF", variantId: 66165 }
      ]},
      "11\" x 14\"": { price: null, colors: [
        { name: "Black", hex: "#1c1c1c", variantId: 65400 },
        { name: "White", hex: "#FFFFFF", variantId: 65401 }
      ]},
      "12\" x 18\"": { price: null, colors: [
        { name: "Black", hex: "#1c1c1c", variantId: 65402 },
        { name: "White", hex: "#FFFFFF", variantId: 65403 }
      ]},
      "16\" x 20\"": { price: null, colors: [
        { name: "Black", hex: "#1c1c1c", variantId: 66226 },
        { name: "White", hex: "#FFFFFF", variantId: 66228 }
      ]},
      "18\" x 24\"": { price: null, colors: [
        { name: "Black", hex: "#1c1c1c", variantId: 65406 },
        { name: "White", hex: "#FFFFFF", variantId: 65407 }
      ]},
      "20\" x 30\"": { price: null, colors: [
        { name: "Black", hex: "#1c1c1c", variantId: 66227 },
        { name: "White", hex: "#FFFFFF", variantId: 66229 }
      ]},
      "24\" x 36\"": { price: null, colors: [
    ...
    colorsVaryBySize: true,
    shippingSeparate: true
    // ALL PRICES PENDING — need real base costs from Printify before this is orderable.
  },
  ...
  "photo-puzzle": {
    ...
    printProviderId: 80,
    sizes: {
      "96 pcs": { variantId: 80317, price: null }, // PENDING — need real base cost from Printify
      "252 pcs": { variantId: 80318, price: null }, // PENDING
      "500 pcs": { variantId: 74740, price: null }, // PENDING
      "1000 pcs": { variantId: 74741, price: null } // PENDING
    },
    colors: null,
    shippingSeparate: true
  },
