...
The hairline IS identity: match its height on the forehead, its shape across the brow, the depth of the temple recession on each side, and any widow's peak. Match the real forehead height relative to the rest of the face, and the real outline of the skull above the ears. Do not tidy any of it toward a more typical head -- do not lower a high hairline, fill in a receding or thinning one, even out uneven temples, or round off a square or narrow skull. A person is recognisable from the eyebrows up alone, so this is identity, not grooming.
The hairSTYLE is not identity: render it however this art style calls for, and if the customer's request below asks for different hair -- a costume wig, a period style, a shaved head, a character's hairstyle -- give them exactly that. Whatever sits on the head, the hairline, the forehead proportion and the skull outline underneath it stay the person's own.
