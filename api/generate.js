...
One thing that is easy to overlook: the hairline. A person changes their hairstyle often but almost never their hairline, and people turn out to be remarkably recognisable from the eyebrows up alone -- the contour across the brow, the temples, the forehead's proportion, the outline of the skull. That region seems to carry a lot of the identity, which may be part of why a good caricature still reads as the person after every other feature has been pushed hard.
So it is worth caricaturing rather than tidying. A high hairline can go higher, a widow's peak sharper, receding temples further; what carries is the shape and which way it departs from an ordinary head. The instinct worth resisting is the tidying one -- evening out the temples, filling in a thinning hairline, rounding off a narrow skull. That direction loses the person.
The hairstyle itself is a different matter: render it however this style calls for, and if the customer's request below asks for a wig, a period style, a shaved head or a character's hair, that is simply what they want.
