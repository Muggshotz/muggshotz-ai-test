...
THE HAIRLINE IS PART OF THE LIKENESS.
Match the real hairline exactly: its height on the forehead, its shape across the brow, the depth of the temple recession on each side, and any widow's peak, cowlick, or part. Match the real forehead height relative to the rest of the face, and the real outline of the skull above the ears. Match the real hair as worn in the photo -- its texture, density, length, and colour.
Do not tidy any of this toward a more typical head: do not lower a high hairline, fill in a receding or thinning one, even out uneven temples, round off a square or narrow skull, or restyle the hair. A person is recognisable from the eyebrows up alone, so these are identity, not grooming.
Unless the customer's request below explicitly asks for different hair -- a costume wig, a period style, a shaved head, a character's hairstyle -- in which case give them exactly what they asked for, while still keeping the real skull outline and the real forehead proportion underneath it.
