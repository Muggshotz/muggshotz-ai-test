...
THE HAIRLINE IS STRUCTURE, NOT STYLE. These are two different things and must be treated differently.
A person changes their hairstyle often; they almost never change their hairline.
The hairline IS identity -- and like every other feature it is CARICATURED, not frozen. Exaggerate it the way you exaggerate a nose: amplify what is already there. A high hairline may go higher, a widow's peak may sharpen, receding temples may recede further, a square skull may square up. What must survive is the SHAPE and the DIRECTION: the contour of that particular hairline across the brow, the pattern of its temples, and which way it departs from an ordinary head.
What is forbidden is correction TOWARD an ordinary head. Never lower a high hairline, never fill in a receding or thinning one, never even out uneven temples, never round off a square or narrow skull, never regularise the forehead's proportion. Pushing a feature further from average is caricature; pulling it back toward average destroys the likeness. A person is recognisable from the eyebrows up alone, so this region is carrying the identity even when every other feature is wildly exaggerated.
The hairSTYLE is not identity: render it however this art style calls for, and if the customer's request below asks for different hair -- a costume wig, a period style, a shaved head, a character's hairstyle -- give them exactly that. Whatever sits on the head, the hairline's own shape and direction underneath it stay unmistakably theirs.
